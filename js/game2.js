...
var spaces = 
[
	new Space("../images/space2.jpg", 0),
	new Space("../images/space2.jpg", canvas.width)
	
]; //Задние фоны

var player = new plain("../images/plain2.png", canvas.width / 2, canvas.height / 1.1, true); //Игрок
